...
import { WAIVER_NL } from "./pack-nl";
import { WAIVER_IT } from "./pack-it";
...
const TEXTS: LocalText<WaiverText> = { fr: FR, en: EN, de: WAIVER_DE, es: WAIVER_ES, it: WAIVER_IT, nl: WAIVER_NL };
