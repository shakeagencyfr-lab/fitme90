...
export const LIVE_LOCALES: readonly Locale[] = ["fr", "en"] as const;
...
export const DICTS: Record<Locale, Dict> = { fr: fr as Dict, en, de: en, es: en, it: en, nl: en };
...
// en français.
const PHRASES: Partial<Record<Locale, Record<string, string>>> = { en: PHRASES_EN };
