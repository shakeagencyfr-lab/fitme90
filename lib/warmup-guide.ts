...
import { CARDIO_HOW_NL, WARMUP_RULES_NL } from "@/lib/i18n/pack-nl";
import { CARDIO_HOW_IT, WARMUP_RULES_IT } from "@/lib/i18n/pack-it";
import { CARDIO_HOW_ES, WARMUP_RULES_ES } from "@/lib/i18n/pack-es";
...
const RULES: Rule[] = [
  {
    ...
    nl: WARMUP_RULES_NL[0],
    it: WARMUP_RULES_IT[0],
    es: WARMUP_RULES_ES[0],
  },
  {
    ...
    nl: WARMUP_RULES_NL[1],
    it: WARMUP_RULES_IT[1],
    es: WARMUP_RULES_ES[1],
  },
  {
    ...
    nl: WARMUP_RULES_NL[2],
    it: WARMUP_RULES_IT[2],
    es: WARMUP_RULES_ES[2],
  },
  {
    test: /hanche|hip/,
    ...
    nl: WARMUP_RULES_NL[3],
    it: WARMUP_RULES_IT[3],
    es: WARMUP_RULES_ES[3],
  },
  {
    ...
    nl: WARMUP_RULES_NL[4],
    it: WARMUP_RULES_IT[4],
    es: WARMUP_RULES_ES[4],
  },
  {
    ...
    nl: WARMUP_RULES_NL[5],
    it: WARMUP_RULES_IT[5],
    es: WARMUP_RULES_ES[5],
  },
  {
    ...
    nl: WARMUP_RULES_NL[6],
    it: WARMUP_RULES_IT[6],
    es: WARMUP_RULES_ES[6],
  },
  {
    ...
    nl: WARMUP_RULES_NL[7],
    it: WARMUP_RULES_IT[7],
    es: WARMUP_RULES_ES[7],
  },
  {
    test: /genou|knee/,
    ...
    nl: WARMUP_RULES_NL[8],
    it: WARMUP_RULES_IT[8],
    es: WARMUP_RULES_ES[8],
  },
  {
    ...
    nl: WARMUP_RULES_NL[9],
    it: WARMUP_RULES_IT[9],
    es: WARMUP_RULES_ES[9],
  },
];
