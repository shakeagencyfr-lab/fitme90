    ...
    <div className="flex flex-col gap-5">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="max-w-[70ch] text-[15px] leading-[1.6] text-muted">
          {tx("Choisis comment l'IA génère les programmes : sur la base evidence-based de référence, ou en suivant tes propres règles. Le changement s'applique aux")} <span className="text-body">{tx("prochaines")}</span> {tx("générations. Le plafond de messages au Coach IA se règle désormais par offre, dans")} <Link href="/admin/plans" className="text-brand hover:underline">{tx("Plans")}</Link>.</p>
      </div>
