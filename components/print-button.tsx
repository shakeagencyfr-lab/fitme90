...
/** Habillage commun au bouton d'impression et au lien de téléchargement. */
export const pdfButtonClass =
  "tap inline-flex h-11 items-center justify-center gap-2 rounded-btn bg-brand px-5 text-[14.5px] font-semibold text-white hover:bg-brand-hover";
...
export function PrintButton({ label = "Enregistrer en PDF", className }: { label?: string; className?: string }) {
  return (
    <button
      ...
      className={className ?? pdfButtonClass}
    >
