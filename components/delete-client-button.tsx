    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          <button aria-label="Fermer" onClick={() => setOpen(false)} className="absolute inset-0 bg-ink/40 backdrop-blur-[2px]" />
          <div className="relative z-10 flex w-full max-w-[460px] flex-col gap-4 rounded-card border border-line bg-surface p-6">
            <h2 className="font-archivo font-extrabold text-[20px] tracking-[-0.02em] text-ink">Supprimer {name} ?</h2>
            <p className="text-[14px] leading-relaxed text-body">
              Cette action est <span className="font-semibold text-ink">irréversible</span>. Tout est effacé : programme,
              séances, pesées, mensurations, messages, notes, et le compte du client. Il pourra se réinscrire de zéro.
            </p>
